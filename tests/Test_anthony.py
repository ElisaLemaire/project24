...
import pandas as pd
import urllib.error
from Chrfinder import find_boiling_point, find_pka, get_df_properties
...
class TestFindBoilingPoint:
    ...
    def test_no_data(self):
        assert find_boiling_point({'Some_other_property': [{'Value': {'StringWithMarkup': [{'String': 'random value'}]}}]}) is None
